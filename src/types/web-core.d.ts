...
export declare class Http {
    ...
    request<T = any>(url: HttpPath, requestOptions?: RequestOptions, middleware?: HttpMiddleware | HttpMiddleware[]): Promise<T>;
    get<T = any>(url: HttpPath, params?: HttpUrlParams, requestOptions?: RequestOptions, middleware?: HttpMiddleware | HttpMiddleware[]): Promise<T>;
