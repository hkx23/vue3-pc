let St = Object.defineProperty;
let _t = (t, e, r) => (e in t ? St(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : (t[e] = r));
let y = (t, e, r) => (_t(t, typeof e !== 'symbol' ? e + '' : e, r), r);
let xt = typeof global === 'object' && global && global.Object === Object && global;
const ht = xt;
let Ct = typeof self === 'object' && self && self.Object === Object && self,
  kt = ht || Ct || Function('return this')();
const $ = kt;
let Ut = $.Symbol;
const M = Ut;
let dt = Object.prototype; var Rt = dt.hasOwnProperty; var It = dt.toString; var C = M ? M.toStringTag : void 0;
function Lt(t) {
  let e = Rt.call(t, C); var r = t[C];
  try {
    t[C] = void 0;
    var n = !0;
  } catch {}
...
let Mt = Object.prototype; var Wt = Mt.toString;
function Ft(t) {
  return Wt.call(t);
}
let Dt = '[object Null]',
...
let qt = '[object Symbol]';
function Vt(t) {
  return typeof t === 'symbol' || (R(t) && S(t) == qt);
}
let zt = Array.isArray;
const yt = zt;
let Ht = /\s/;
function Jt(t) {
...
let Z = 0 / 0; var Kt = /^[-+]0x[0-9a-f]+$/i; var Yt = /^0b[01]+$/i; var Xt = /^0o[0-7]+$/i; var Qt = parseInt;
function tt(t) {
  if (typeof t === 'number') return t;
  if (Vt(t)) return Z;
  if (P(t)) {
    let e = typeof t.valueOf === 'function' ? t.valueOf() : t;
    t = P(e) ? `${e  }` : e;
  }
...
let ne = $['__core-js_shared__'];
const D = ne;
let et = (function () {
  let t = /[^.]+$/.exec((D && D.keys && D.keys.IE_PROTO) || '');
  return t ? `Symbol(src)_1.${  t}` : "";
})();
function oe(t) {
  return !!et && et in t;
}
let ie = Function.prototype; var se = ie.toString;
function _(t) {
  if (t != null) {
    try {
      return se.call(t);
...
let ae = /[\\^$.*+?()[\]{}|]/g; var ce = /^\[object .+?Constructor\]$/; var ue = Function.prototype; var fe = Object.prototype; var le = ue.toString; var pe = fe.hasOwnProperty; var ge = RegExp(
  `^${  le.call(pe).replace(ae, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?")  }$`
  );
function he(t) {
  if (!P(t) || oe(t)) return !1;
  let e = mt(t) ? ge : ce;
  return e.test(_(t));
}
function de(t, e) {
...
let we = Object.prototype;
function wt(t) {
  let e = t && t.constructor; var r = typeof e === "function" && e.prototype || we;
  return t === r;
}
let ve = '[object Arguments]';
function rt(t) {
  return R(t) && S(t) == ve;
}
let vt = Object.prototype; var Te = vt.hasOwnProperty; var je = vt.propertyIsEnumerable; var Ae = rt(function() {
      return arguments;
    })(),
  )
    ? rt
...
let Tt = typeof exports === 'object' && exports && !exports.nodeType && exports,
  nt = Tt && typeof module == 'object' && module && !module.nodeType && module,
  Ee = nt && nt.exports === Tt,
  ot = Ee ? $.Buffer : void 0,
  Pe = ot ? ot.isBuffer : void 0,
  Se = Pe || Oe;
const _e = Se;
let xe = '[object Arguments]',
  Ce = '[object Array]',
  ke = '[object Boolean]',
  Ue = '[object Date]',
  Re = '[object Error]',
...
let jt = typeof exports === 'object' && exports && !exports.nodeType && exports,
  k = jt && typeof module == 'object' && module && !module.nodeType && module,
  rr = k && k.exports === jt,
  B = rr && ht.process,
  nr = (function () {
    try {
...
const it = nr;
let st = it && it.isTypedArray; var or = st ? er(st) : tr;
const ir = or;
function sr(t, e) {
  return function (r) {
    return t(e(r));
...
let ar = sr(Object.keys, Object);
const cr = ar;
let ur = Object.prototype; var fr = ur.hasOwnProperty;
function lr(t) {
  if (!wt(t)) return cr(t);
  let e = [];
  for (let r in Object(t)) fr.call(t, r) && r != 'constructor' && e.push(r);
  return e;
}
let pr = I($, 'Map');
const z = pr;
...
let at = '[object Map]',
  ...
  Tr = _(V),
  E = S;
((H && E(new H(new ArrayBuffer(1))) != lt) ||
  (z && E(new z()) != at) ||
  (J && E(J.resolve()) != ct) ||
  (G && E(new G()) != ut) ||
  (V && E(new V()) != ft)) &&
  (E = function (t) {
  let e = S(t); var r = e == yr ? t.constructor : void 0; var n = r ? _(r) : "";
    if (n)
      switch (n) {
        case mr:
          return lt;
...
const q = Ar;
let $r = 'Expected a function',
  Or = Math.max,
  Er = Math.min;
function At(t, e, r) {
  let n; var o; var p; var u; var f; var a; var i = 0; var s = !1; var l = !1; var w = !0;
  if (typeof t !== 'function') throw new TypeError($r);
  (e = tt(e) || 0),
    P(r) &&
      ((s = !!r.leading),
      (l = 'maxWait' in r),
      (p = l ? Or(tt(r.maxWait) || 0, e) : p),
  ...
  function A() {
    ...
    if (((n = arguments), (o = this), (a = b), O)) {
      if (f === void 0) return h(a);
      if (l) return clearTimeout(f), (f = setTimeout(v, e)), m(a);
    }
    return f === void 0 && (f = setTimeout(v, e)), u;
  }
  return (A.cancel = d), (A.flush = F), A;
}
let Pr = '[object String]';
function pt(t) {
...
let Sr = '[object Map]',
  _r = '[object Set]',
  xr = Object.prototype,
  Cr = xr.hasOwnProperty;
function kr(t) {
  if (t == null) return !0;
  if (be(t) && (yt(t) || typeof t === 'string' || typeof t.splice == 'function' || _e(t) || ir(t) || $e(t)))
    return !t.length;
  let e = jr(t);
  if (e == Sr || e == _r) return !t.size;
  if (wt(t)) return !lr(t).length;
  for (let r in t) if (Cr.call(t, r)) return !1;
  return !0;
}
let Ur = 'Expected a function';
function Rr(t, e, r) {
  let n = !0; var o = !0;
  if (typeof t !== 'function') throw new TypeError(Ur);
  return (
    P(r) && ((n = 'leading' in r ? !!r.leading : n), (o = 'trailing' in r ? !!r.trailing : o)),
    At(t, e, {
      leading: n,
      maxWait: e,
      trailing: o,
...
var $t = /* @__PURE__ */ ((t) => (
  ...
  (t.FormURLEncoded = 'application/x-www-form-urlencoded;charset=UTF-8'),
  (t.FormData = 'multipart/form-data;charset=UTF-8'),
  t
))($t || {});
class Ir {
  constructor() {
...
class N {
  ...
  normalizeUrlParams(e, r) {
    ...
    return typeof r === 'object'
      ? n +
          Object.entries(r)
            .map((o) => encodeURIComponent(o[0]) + '=' + encodeURIComponent(o[1] || ''))
            .join('&')
      : r !== ''
      ? n + L(r)
      : '';
...
class Lr {
  ...
  createContext(e, r = {}) {
    const n = this.options; const o = L(n.baseURL);
    let p = L(e);
    ...
    return (
      (u.baseURL = o),
      (u.path = p),
      (u.url = this.getUrl(o, p, r.params)),
      (u.requestOptions = {
        headers: {},
        timeout: n.timeout,
        ...r,
  ...
  createRequest(e, r = {}, n = []) {
    const o = this.createContext(e, r); const p = this.options;
    let u = [];
    typeof p.middlewares === 'function' && (u = u.concat(L(p.middlewares))),
      (u = u.concat(this.middlewares)),
      n && (typeof n == 'function' ? u.push(n) : n instanceof Array && n.length > 0 && (u = u.concat(n)));
    const f = (a) => {
      const i = u[a];
      if (!i) {
...
class Mr {
  ...
  values() {
    const e = [];
    for (const r in this.items) this.has(r) && e.push(this.items[r]);
    return e;
  }
  ...
  count() {
    let e = 0;
    for (const r in this.items) this.has(r) && e++;
    return e;
  }
}
function Wr(t) {
...
let Ot = { exports: {} };
(function (t) {
  let e = Object.prototype.hasOwnProperty; var r = "~";
  function n() {}
  ...
  function p(a, i, s, l, w) {
    ...
    let m = new o(s, l || a, w); var h = r ? r + i : i;
    return (
      a._events[h]
        ? a._events[h].fn
          ? (a._events[h] = [a._events[h], m])
          : a._events[h].push(m)
        : ((a._events[h] = m), a._eventsCount++),
      a
    );
  }
  function u(a, i) {
  ...
  (f.prototype.eventNames = function () {
    ...
    for (l in (s = this._events)) e.call(s, l) && i.push(r ? l.slice(1) : l);
    ...
    (f.prototype.listeners = function (i) {
      ...
      if (!l) return [];
      if (l.fn) return [l.fn];
      for (var w = 0, m = l.length, h = new Array(m); w < m; w++) h[w] = l[w].fn;
      return h;
    }),
    ...
    (f.prototype.emit = function (i, s, l, w, m, h) {
      ...
      if (c.fn) {
        ...
        for (d = 1, j = new Array(v - 1); d < v; d++) j[d - 1] = arguments[d];
        ...
        for (d = 0; d < F; d++)
          switch ((c[d].once && this.removeListener(i, c[d].fn, void 0, !0), v)) {
            ...
            case 4:
              ...
              break;
            default:
              if (!j) for (A = 1, j = new Array(v - 1); A < v; A++) j[A - 1] = arguments[A];
    ...
    (f.prototype.removeListener = function (i, s, l, w) {
      ...
      if (!s) return u(this, m), this;
      var h = this._events[m];
      if (h.fn) h.fn === s && (!w || h.once) && (!l || h.context === l) && u(this, m);
      else {
    ...
    (f.prototype.removeAllListeners = function (i) {
      var s;
      return (
        i ? ((s = r ? r + i : i), this._events[s] && u(this, s)) : ((this._events = new n()), (this._eventsCount = 0)),
        this
      );
    }),
...
class W {
  ...
  remove(e, r, n) {
    ...
    return (
      ...
      r && n
        ? (o = this.targets.get(r)) == null || o.emitter.removeListener(e, n)
        : this.targets.map((p, u) => {
  ...
  on(e, r, n) {
    ...
    return (
      typeof r == 'function' && ((n = r), (r = '*')),
      n && (this.addTarget(r), (o = this.targets.get(r)) == null || o.emitter.on(e, n)),
      this
    );
  }
  ...
  once(e, r, n) {
    ...
    return (
      typeof r == 'function' && ((n = r), (r = '*')),
      n && (this.addTarget(r), (o = this.targets.get(r)) == null || o.emitter.once(e, n)),
      this
    );
  }
...
class gt extends Error {
  constructor(r, n, o, p = '') {
    ...
    (this.message = r),
      ...
      (this.type = 'error'),
      (this.description = p),
      (u = Vr.targets.get('self')) == null || u.send('custom_error', this);
  }
}
...
const Hr = async (t, e) => {
  ...
  Jr = async (t, e) => {
    ...
    (a = t.response) != null &&
      ...
      (t.result = await ((i = t.response) == null ? void 0 : i.json()));
  },
  Gr = async (t, e) => {
    var p, u, f, a;
    const n = t.requestOptions.headers,
      o = U.getToken();
    if (
      (o && kr(n.Authorization) && (n.Authorization = `Bearer ${o}`), await e(), !((p = t.response) != null && p.ok))
    ) {
      const i = new Error('An error occurred while fetching the data.');
      throw (
        ((i.message = `${(u = t.response) == null ? void 0 : u.status}|${
          (await ((f = t.response) == null ? void 0 : f.text())) || ''
        }`),
        i)
      );
    }
    ...
    if (!t.requestOptions.returnNativeResponse) {
      const i = t.result;
      if (i.code === 0 || i.code === 200) t.result = i.data;
      else if (i.message) throw new gt(i.message, i.code, t.response.status, JSON.stringify(i));
    }
  },
  Nr = async (t, e) => {
...
window.http = Kr;
window.fw = U;
export { gt as CustomError, Mr as Dictionary, W as EventBus, Lr as Http };
