      ...
      <t-space direction="vertical" style="width: 680px">
        ...
        <t-row :gutter="[10, 10]">
          <t-col flex="300px">
            <bcmp-select-business
              v-model="plantValue"
              component-type="list2"
              :is-multiple="true"
              type="plant"
            ></bcmp-select-business
          ></t-col>
          <t-col flex="300px">
            <t-input v-model="plantValueSplit" label="工厂值" disabled />
          </t-col>
        </t-row>

        <t-row :gutter="[10, 10]">
          <t-col flex="300px">
            <bcmp-select-business v-model="plantSingleValue" component-type="list2" type="plant"></bcmp-select-business
          ></t-col>
          <t-col flex="300px">
            <t-input v-model="plantSingleValue" label="工厂值" disabled />
          </t-col>
        </t-row>
        <!-- 车间 -->
        <t-row :gutter="[10, 10]">
        ...
        <t-row :gutter="[10, 10]">
          <t-col flex="300px">
            <bcmp-select-business v-model="processValue" type="process"></bcmp-select-business
          ></t-col>
          <t-col flex="300px">
...
const plantValueSplit = computed(() => plantValue.value.map((item) => item.value).join(','));
...
onMounted(() => {
  ...
  districtValue.value = '';
  locationValue.value = '';
  plantValue.value = [{ value: '1744167886127157249', label: '螺母M10' }];
  workshopValue.value = '';
