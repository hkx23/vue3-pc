...
export const api = {
  ...
  pqcInspectFirst: {
     ...
     * @name GetBarcodeList
     * @summary 获得明细的条码数据
     * @request POST:/pqcInspectFirst/getBarcodeList
     * @secure
     */
    getBarcodeList: (data: string) =>
      http.request<ResultListPqcInspectFirstVO['data']>(`/api/quality/pqcInspectFirst/getBarcodeList`, {
        method: 'POST',
        body: data as any,
      }),
